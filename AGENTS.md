...
This project is indexed by GitNexus as **Pulse** (719 symbols, 1690 relationships, 48 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
